...
export const MOCK_COURSES: Course[] = [
  ...
  { id: "mock-3", title: "AI for Architecture", format: "Pre-Recorded", level: "beginner", topic: "artificial intelligence", upcoming: false, prerequisites: [], priceEur: 150, url: "https://paacademy.com/courses/ai-for-architecture" }
];
